                        ...
                        BottomSheetScaffold(
                            ...
                            NavHost(
                                ...
                                composable("artistsScreen"){
                                    ArtistsScreen(
                                        activityMainViewModel = activityMainViewModel,
                                        onArtistClicked = {navController.navigate("artistScreen")}
                                    )
                                }
                                composable("albumsScreen"){
                                    AlbumsScreen(
                                        activityMainViewModel = activityMainViewModel,
                                        onAlbumClicked = { navController.navigate("albumScreen") }
                                    )
                                }
                                ...
                                composable("artistScreen"){
                                    ArtistScreen(
                                        activityMainViewModel = activityMainViewModel,
                                        onBackClicked = {  navController.navigateUp() },
                                        onArtistAlbumOpened = { navController.navigate("artistAlbumScreen") }
                                    )
                                }
                                composable("artistAlbumScreen"){
                                    AlbumScreen(
                                        activityMainViewModel = activityMainViewModel,
                                        albumID = activityMainViewModel.clickedArtistAlbumID.value!!,
                                        onBackClicked = { navController.navigateUp() },
                                    )
                                }
                                composable("albumScreen"){
                                    AlbumScreen(
                                        activityMainViewModel = activityMainViewModel,
                                        albumID = activityMainViewModel.clickedAlbumID.value!!,
                                        onBackClicked = { navController.navigateUp() }
                                    )
                                }
