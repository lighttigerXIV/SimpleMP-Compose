...
class SettingsRepository(
    ...
    private fun getSettings(preferences: Preferences): Settings {
        return Settings(
            ...
            lightTheme = preferences[Keys.LIGHT_THEME] ?: SettingsOptions.Themes.TIGER_BANANA ,
            darkTheme = preferences[Keys.DARK_THEME] ?: SettingsOptions.Themes.PANTHER_BANANA,
    ...
    private fun getDefaultSettings(): Settings {
        return Settings(
            ...
            lightTheme = SettingsOptions.Themes.TIGER_BANANA,
            darkTheme = SettingsOptions.Themes.PANTHER_BANANA,
            durationFilter = 60,
